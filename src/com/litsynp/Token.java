...
public class Token {
	...
	// If tokenCandidate matches with any of the defined pattern, returns the token name (type)
...
//		pattern = Pattern.compile(bracePattern);
//		match = pattern.matcher(tokenCandidate);
//		if (match.matches()) {
//			return "BRACE";
//		}
//		
//		pattern = Pattern.compile(parenPattern);
//		match = pattern.matcher(tokenCandidate);
//		if (match.matches()) {
//			return "BRACKET";
//		}
